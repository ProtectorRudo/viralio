(() => {
  ...
  function saveGift(prize) {
    const message = `Hola Moka 👋 Quiero guardar mi regalo de Viralio.\n🎁 Premio: ${prize.name}\n🎟️ Código: ${prize.code}\n📅 Vence: ${expirationDate()}`;
  ...
  function renderReward() {
    ...
    shell(`
      <div class="stage reward-stage">
        <div class="reward-burst" aria-hidden="true"><div class="reward-medal"><span>M</span></div></div>
        <div class="stage-copy">
          <p class="kicker">Este regalo es tuyo</p>
          <h1>${prize.name}</h1>
          <p class="lead">Guardalo por WhatsApp y presentalo en Moka antes de la fecha de vencimiento.</p>
        </div>
