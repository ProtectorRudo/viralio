...
const familyTokens: Record<MerchantBrandArtDirection["family"], BrandRenderVariables> = {
  "editorial-luxury": {
    ...
    "--brand-campaign-min-height": "clamp(430px, 58vh, 530px)",
    "--brand-campaign-align-items": "end",
    "--brand-campaign-pad-top": "34px",
    "--brand-campaign-pad-bottom": "32px",
    "--brand-heading-max": "8.5ch",
    "--brand-lead-margin-top": "22px",
    "--brand-campaign-visual-width": "100%",
    "--brand-campaign-visual-margin-inline": "0px",
    "--brand-campaign-visual-border": "1px solid color-mix(in srgb, var(--color-text) 10%, transparent)",
    "--brand-campaign-visual-min-height": "310px",
    "--brand-share-width": "100%",
    "--brand-share-shadow": "none",
    "--brand-share-border-width": "1px",
  },
  "warm-crafted": {
    "--brand-family-density": ".94",
    "--brand-family-whitespace": "1.04",
    "--brand-family-contrast": ".94",
    "--brand-campaign-min-height": "clamp(440px, 56vh, 510px)",
    "--brand-campaign-align-items": "center",
    "--brand-campaign-pad-top": "24px",
    "--brand-campaign-pad-bottom": "28px",
    "--brand-heading-max": "10ch",
    "--brand-lead-margin-top": "18px",
    "--brand-campaign-visual-width": "min(82%, 290px)",
    "--brand-campaign-visual-margin-inline": "auto",
    "--brand-campaign-visual-border": "0px solid transparent",
    "--brand-campaign-visual-min-height": "250px",
    "--brand-share-width": "min(92%, 360px)",
    "--brand-share-shadow": "0 14px 34px color-mix(in srgb, var(--color-text) 7%, transparent)",
    "--brand-share-border-width": "1px",
  },
  "bold-contemporary": {
    ...
    "--brand-campaign-min-height": "clamp(410px, 54vh, 490px)",
    "--brand-campaign-align-items": "stretch",
    "--brand-campaign-pad-top": "18px",
    "--brand-campaign-pad-bottom": "24px",
    "--brand-heading-max": "11ch",
    "--brand-lead-margin-top": "16px",
    "--brand-campaign-visual-width": "calc(100% + 24px)",
    "--brand-campaign-visual-margin-inline": "-12px",
    "--brand-campaign-visual-border": "0px solid transparent",
    "--brand-campaign-visual-min-height": "300px",
    "--brand-share-width": "100%",
    "--brand-share-shadow": "0 12px 26px color-mix(in srgb, var(--color-text) 10%, transparent)",
    "--brand-share-border-width": "2px",
  },
  "minimal-professional": {
    "--brand-family-density": ".9",
    "--brand-family-whitespace": "1.08",
    "--brand-family-contrast": "1",
    "--brand-campaign-min-height": "clamp(360px, 50vh, 450px)",
    "--brand-campaign-align-items": "center",
    "--brand-campaign-pad-top": "18px",
    "--brand-campaign-pad-bottom": "18px",
    "--brand-heading-max": "12ch",
    "--brand-lead-margin-top": "14px",
    "--brand-campaign-visual-width": "100%",
    "--brand-campaign-visual-margin-inline": "0px",
    "--brand-campaign-visual-border": "0px solid transparent",
    "--brand-campaign-visual-min-height": "210px",
    "--brand-share-width": "100%",
    "--brand-share-shadow": "none",
    "--brand-share-border-width": "1px",
  },
...
const layoutTokens: Record<MerchantBrandArtDirection["layoutMood"], BrandRenderVariables> = {
  "centered-hero": {
    ...
    "--brand-layout-media-scale-mobile": ".92",
  },
  "asymmetrical-editorial": {
    ...
    "--brand-layout-media-scale-mobile": "1",
  },
  ...
  "compact-premium": {
    ...
    "--brand-layout-media-scale-mobile": ".84",
  },
};
